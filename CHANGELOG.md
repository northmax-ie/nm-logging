...
- Isolation from foreign logging: nm-logging neither configures standard-library,
  framework, or third-party logging nor provides a `logging.Handler`, sink
  adapter, or other bridge into authoritative NorthMax storage. NorthMax records
  are not forwarded into standard-library logging.
